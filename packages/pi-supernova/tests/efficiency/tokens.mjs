...
import { auditWorkload, runWorkload, workloadHash, trafficCounts } from "./workflow.mjs";
...
const candidate = await runWorkload(workload,{batch:!!parameters.properties.programs});
